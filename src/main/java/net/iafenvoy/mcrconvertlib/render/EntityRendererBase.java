package net.iafenvoy.mcrconvertlib.render;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import net.iafenvoy.mcrconvertlib.misc.Stage;
...
public class EntityRendererBase<T extends MobEntity> extends BipedEntityRenderer<T, BipedEntityModel<T>> {
    ...
    public EntityRendererBase(EntityRendererFactory.Context context, Stage.StagedEntityTextureProvider textureId, Identifier eyeTextureId) {
